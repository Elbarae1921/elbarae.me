...
export const AboutMe = () => {
  return (
    <SectionLayout classes="about section-padding mb-5" id="about">
      <div className="w-100 col-md-6 position-relative">
        <Image
      ...
      <div className="col-md-6 my-auto pl-5">
        ...
        <div className="about-body ml-lg-4 pl-lg-3 pb-5">
          <p>
            I&quot;m currently a Full-stack developer (mostly Flutter and some
            Ops) at &nbsp;
            <a href="https://bewizyu.com/" target="_blank" rel="noreferrer">
              Bewizyu
            </a>
            . I love javascript and I love using it to build wonderful things.
            <br />
